            ...
            <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                ...
                <div className="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                    <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li>
                            <a href="#" className="block py-2 pl-3 pr-4 text-white bg-darkGreen rounded lg:bg-transparent lg:text-darkGreen lg:p-0 dark:text-white" aria-current="page">Home</a>
                        </li>
                        <li>
    ...
    >
      <div className="container mx-auto py-[200px] pb-[150px]">
        <div className="banner-content text-center">
          <div className="banner-title text-[160px] font-semibold text-black mb-4">Harvesta</div>
          <div className="banner-desc text-xl text-black mb-6">Sell or buy your products straight from the farms.</div>
        </div>
        <div 
            ...
            <div className="lg:w-1/2 w-full">
              <div className="fruits-right ml-5">
                <div className="section-header text-center lg:text-left">
                  ...
                  <a href="#" className="mt-6 inline-block bg-darkGreen text-white py-2 px-6 rounded-full text-lg hover:darkBrown transition duration-300">
                    <span>Buy Now</span>
                  </a>
                </div>
              </div>
